...
| :-------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------ | :-----------| :-----------|
| [Hacker-Goose](https://github.com/I-Am-Jakoby/Flipper-Zero-BadUSB/tree/main/Payloads/Flip-HackerGoose)          | A payload that hires a goose to hack your target in real time                                     |✅           | Jakoby      |      
